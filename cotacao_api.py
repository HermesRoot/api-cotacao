...
app = Flask(__name__)
CORS(app, resources={r"/cotacao": {"origins": "*"}})  # Permite acesso externo apenas para /cotacao
...
def atualizar_cotacoes():
    ...
    while True:
        ...
        time.sleep(UPDATE_INTERVAL)  # Espera 5 minutos antes da próxima atualização
